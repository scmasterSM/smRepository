...
<script type="text/javascript">
	...
	$(function() {
	  ...
	  var pop_cities = [{"index" : 0, "areaCode" : 1, "sigunguCode" : "", "name" : '서울', "name_en" : "Seoul", "lat" : parseFloat(37.566535), "lng" : parseFloat(126.9779692), "is_state" : 0},
			...
			<div class="row">
				<div
					...
					<div class="search-form wow pulse" data-wow-delay="0.8s">
						<form action="" class=" form-inline" onsubmit="return city_search();">
							<div class="form-group">
