      ...
      $.getJSON(url2,function(data) {
         ...
         // var cityname = "<h1>"+addr1+"</h1>";
          ...
          for (var i = 0; i < data.response.body.items.item.length; i++) {
             ...
             content += '<a href="SC_07place?CONTENT_ID='+con+'&CONTENT_TYPE_ID='+conType+'"><img src='+data.response.body.items.item[i].firstimage2+' width=200 height=150></a>';
             } else {
             content += '<a href="SC_07place?CONTENT_ID='+con+'&CONTENT_TYPE_ID='+conType+'"><img src="./resources/image/noimage.jpg"></a>';
             }
             content += '<div class="caption">';
             content += '<a href="SC_07place?CONTENT_ID='+con+'&CONTENT_TYPE_ID='+conType+'"><h4>'+data.response.body.items.item[i].title+'</h4></a>';
      ...
      $.getJSON(url,function(data) {
                     ...
                     for (var i = 0; i < data.response.body.items.item.length; i++) {
                        ...
                        if (typeof (data.response.body.items.item[i].firstimage2) !== "undefined") {
                           ...
                           //console.log('테스트 if');
                           content2 += '<a href="SC_07place?CONTENT_ID='+con+'&CONTENT_TYPE_ID='+conType+'"><img src='+data.response.body.items.item[i].firstimage2+' width=200 height=150></a>';
                        } else {
                           //console.log('테스트 else');
                           content2 += '<a href="SC_07place?CONTENT_ID='+con+'&CONTENT_TYPE_ID='+conType+'"><img src="./resources/image/noimage.jpg"></a>';
                        }
                        content2 += '<div class="caption">';
                        content2 += '<h4><a href="SC_07place?CONTENT_ID='+con+'&CONTENT_TYPE_ID='+conType+'">'
                        ...
                        modal1 += '<a href="SC_07place?CONTENT_ID='+con+'&CONTENT_TYPE_ID='+conType+'"><h4>'+ data.response.body.items.item[i].title +'</h4></a>';   
