...
public class Clip {
	...
	public Clip(int cLIP_SQ, String uSER_ID, String cONTENT_ID, String cONTENTTYPE_ID, Date cLIP_YMD) {
		super();
		CLIP_SQ = cLIP_SQ;
		USER_ID = uSER_ID;
	...
	public String toString() {
		return "Clip [CLIP_SQ=" + CLIP_SQ + ", USER_ID=" + USER_ID + ", CONTENT_ID=" + CONTENT_ID + ", CONTENTTYPE_ID="
				+ CONTENTTYPE_ID + ", CLIP_YMD=" + CLIP_YMD + "]";
	}
